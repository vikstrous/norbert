...
class ConsistentHashPartitionedLoadBalancerFactorySpec extends Specification {
  ...
  class EIdDefaultLoadBalancerFactory(numPartitions: Int, serveRequestsIfPartitionMissing: Boolean) extends DefaultPartitionedLoadBalancerFactory[EId](numPartitions, 0, serveRequestsIfPartitionMissing) {
